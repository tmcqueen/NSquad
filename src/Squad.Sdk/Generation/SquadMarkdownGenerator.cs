...
/// <summary>A markdown file generated by <see cref="SquadMarkdownGenerator"/>.</summary>
/// <param name="RelPath">Relative path from the project root (e.g. <c>.squad/team.md</c>).</param>
/// <param name="Content">Full file content to write.</param>
